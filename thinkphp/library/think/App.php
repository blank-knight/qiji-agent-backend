...
class App
{
    ...
    public static function module($result, $config, $convert = null)
    {
        ...
        // 多级控制器支持：如果控制器文件不存在但同名目录存在，
        // 则将 controller/action 视为多级控制器 controller.Action，action 取下一级
        $controllerLayerDir = APP_PATH . ($module ? $module . DS : '') . $config['url_controller_layer'] . DS;
        $controllerFile = $controllerLayerDir . Loader::parseName($controller, 1) . '.php';
        $controllerDir  = $controllerLayerDir . $controller;
