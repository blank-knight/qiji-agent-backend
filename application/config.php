...
// +----------------------------------------------------------------------
// | Author: yunwuxin <448905919@qq.com>
// +----------------------------------------------------------------------
...
return [
    ...
    'database'             => [
        ...
        // 数据库名
        'database'        => \think\Env::get('database.database', 'qiji_admin'),
        // 用户名
        ...
        // 数据库调试模式
        'debug'           => \think\Env::get('app.debug', false),
