define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form,Layui) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'media_order/index',
                    add_url: 'media_order/add',
                    // edit_url: 'media_order/edit',
                    // del_url: 'media_order/del',
                    multi_url: 'media_order/multi',
                    table: 'media_order',
                }
            });
...
function cancel_order(id){
    layer.confirm('是否取消订单，系统会自动退款？', {icon: 3, title:'谨慎操作',shade: 0.7,closeBtn: 2,  anim: 1}, function(index){
        ...
        $.post('/user/media_order/cancel_order',{id:id},function(data){
