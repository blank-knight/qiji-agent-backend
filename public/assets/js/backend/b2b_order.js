define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form,Layui) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'b2b_order/index',
                    add_url: 'b2b_order/add',
                    // edit_url: 'b2b_order/edit',
                    // del_url: 'b2b_order/del',
                    multi_url: 'b2b_order/multi',
                    table: 'b2b_order',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'status', title: '稿件状态', formatter: Table.api.formatter.status, searchList: {0: '发布中', 1:'已发布',2:'已退款',3:'售后中',4:'已安排'}},
...
function cancel_order(id){
    layer.confirm('是否取消订单，系统会自动退款？', {icon: 3, title:'谨慎操作',shade: 0.7,closeBtn: 2,  anim: 1}, function(index){
        ...
        $.post('/user/b2b_order/cancel_order',{id:id},function(data){
