...
$menus = [
    ...
    [1, 'general/config', '系统配置', 'fa fa-gears', '', '', 1, $now, $now, 90, 'normal'],
    [0, 'agent', '代理管理', 'fa fa-users', '', '', 1, $now, $now, 80, 'normal'],
    [4, 'agent/agent', '代理列表', 'fa fa-list', '', '', 1, $now, $now, 99, 'normal'],
    [4, 'agent/agentinvite', '邀请码', 'fa fa-ticket', '', '', 1, $now, $now, 98, 'normal'],
    [0, 'user', '用户管理', 'fa fa-user', '', '', 1, $now, $now, 90, 'normal'],
    [7, 'user/user', '用户列表', 'fa fa-list', '', '', 1, $now, $now, 99, 'normal'],
    [0, 'statistics', '统计中心', 'fa fa-bar-chart', '', '', 1, $now, $now, 70, 'normal'],
    [9, 'statistics/scorelog', 'Token消耗记录', 'fa fa-list', '', '', 1, $now, $now, 99, 'normal'],
    [0, 'version', '版本管理', 'fa fa-upload', '', '', 1, $now, $now, 60, 'normal'],
    [11, 'version/index', '版本列表', 'fa fa-list', '', '', 1, $now, $now, 99, 'normal'],
    [0, 'auth', '权限管理', 'fa fa-shield', '', '', 1, $now, $now, 50, 'normal'],
    [13, 'auth/admin', '管理员管理', 'fa fa-users', '', '', 1, $now, $now, 99, 'normal'],
    [13, 'auth/group', '角色组', 'fa fa-users', '', '', 1, $now, $now, 98, 'normal'],
    [13, 'auth/rule', '菜单规则', 'fa fa-list', '', '', 1, $now, $now, 97, 'normal'],
];
